...
function Dashboard({ user, savedCount, applicationCount }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const reasoning =
                    pct >= 80
                        ? "🌟 Your profile is shining! You're ready to attract top employers."
                        : pct >= 50
                            ? "🚀 Great progress! Add a few more details to stand out."
    ...
    const totalItems = profileStrength.breakdown.length;
                ...
                <main className="dashboard-main">
                    ...
                    <section className="dashboard-hero">
                        <div className="hero-content">
                            <div className="hero-badge">
                                <Sparkles size={15} /> YOUR CAREER DASHBOARD
                            </div>
                            <h1>
                                Good to see you, <span>{firstName}</span>
                            </h1>
                            <p>
                                Your personalized workspace for discovering opportunities, tracking progress, and growing your career.
                            </p>
                    ...
                    <section className="dashboard-stats-grid">
                        <div className="premium-stat-card">
                            ...
                            <div className="stat-info">
                                ...
                                <small>Opportunities you saved</small>
                            </div>
                        ...
                        <div className="premium-stat-card">
                            ...
                            <div className="stat-info">
                                ...
                                <strong>{profileStrength.percentage}%</strong>
                                <small>Keep improving your profile</small>
                            </div>
                            <ChevronRight className="stat-arrow" size={18} />
                        </div>
                    </section>

                    {/* ─── AI Insight + Profile Strength ──────────────── */}
                    <section className="dashboard-insights-grid">
                        <div className="ai-insight-card">
                            <div className="insight-top">
                                ...
                                <div>
                                    <span className="section-eyebrow">AI POWERED INSIGHT</span>
                            ...
                            <div className="insight-recommendation">
                                ...
                                <div>
                                    ...
                                    <span>Improve your profile to increase your career match accuracy.</span>
                                </div>
                            </div>
                        ...
                        <div className="profile-strength-modern">
                            <div className="strength-top">
                                <div>
                                    <span className="section-eyebrow">PROFILE PROGRESS</span>
                    ...
                    <section className="profile-checklist-card">
                        <div className="section-header">
                            <div>
                                <span className="section-eyebrow">PROFILE CHECKLIST</span>
                            ...
                            <div className="quick-action-list">
                                <button onClick={() => navigate("/recommendations")}>
                                    ...
                                    <div>
                                        ...
                                        <span>Discover jobs matched to you</span>
                                    </div>
                                    <ArrowRight size={18} />
                                </button>
                                <button onClick={() => navigate("/profile")}>
                                    ...
                                    <div>
                                        ...
                                        <span>Improve your professional profile</span>
                                    </div>
                                    <ArrowRight size={18} />
                                </button>
                                <button onClick={() => navigate("/post-cv")}>
                                    ...
                                    <div>
                                        ...
                                        <span>Make your profile more complete</span>
                                    </div>
                                    <ArrowRight size={18} />
                                </button>
                            </div>

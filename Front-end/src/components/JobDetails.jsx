          ...
          <section className="ai-job-insight">
            ...
            <div className="ai-insight-header">
              ...
              <div>
                ...
                <h3>
                  Want to know if this job matches you?
                </h3>
              </div>
            ...
            <p>
              Get a personalized AI analysis based on your
              skills, experience, and career goals.
            </p>


            <Link
              to={`/recommendations?job=${job.id}`}
        ...
        <aside className="job-details-sidebar">
          ...
          <div className="job-summary-panel glass-card">
            ...
            <p className="apply-note">
              Make sure your profile is complete before
              applying.
            </p>
